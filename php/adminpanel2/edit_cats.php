...
?>
  ...
  <?php while ($row = mysqli_fetch_array($results)) { ?>
    <tr>
      ...
      <td>
        <a href="edit_cats.php?edit=<?php echo $row['cat_id'] ?>" class="btn btn-info" ><?php echo $languages[$x]["up_edit_btn"] ?></a>
      </td>
      <td>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p><?php echo $languages[$x]["up_name"] ?>: <?php echo $row['cat_name'] ?></p>
              <p><?php echo $languages[$x]["up_type"] ?>: <?php echo $row['type'] ?></p>
            </div>
            <div class="modal-footer">
              <a href="edit_cats.php?del=<?php echo $row['cat_id'] ?>" class="btn btn-danger"><?php echo $languages[$x]["up_del_btn"] ?></a>
  ...
  <?php } ?>
    ...
    <div class="inputform">
      <form method="post" action="includes_admin/edit_cats.inc.php" >
        ...
        <label class="col"><?php echo $languages[$x]["up_desc"] ?>: </label><br>
        <div class="input-group form-group">
