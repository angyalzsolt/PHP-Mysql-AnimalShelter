...
<?php foreach($rows as $row){ ?>
        <div class="part_divs col-md-3 offset-md-1 col-sm-5 offset-sm-2 mb-4 mt-2">
            ...
            <div class="buttons_div">
              <a href="includes_admin/delete_dog_img.inc.php?del=<?php echo $row['image_dog_id'] ?>" class="btn btn-danger">Delete</a>
            </div>
          </div>
        </div>
<?php }; ?>
  ...
  <div class="col-md-10 offset-md-2">
    ...
    <form  method="post" action="includes_admin/image_upload_dog3.inc.php" enctype="multipart/form-data" class="mb-4">
      ...
      <p><button type="submit" class="btn btn-primary" value="<?php echo $dogid ?>" name="submitOther">UPLOAD</button></p>
    </form> 
  </div>
  </div>
